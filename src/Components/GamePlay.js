                ...
                <Grid container>
                  <Grid item sm={4}>
                    <div style={{ height: 100 + '%', border: 2 + `px solid ${team.color == 'White' ? 'black' : 'white'}` }}>
                      ...
                      {/* <img style={{ width: 200 + 'px' }} src={black} /> */}
                    </div>
                  </Grid>
                  <Grid item sm={4}>
                    <div style={{ width: '100%', display: 'inline-flex', justifyContent: 'center', border: 2 + `px solid ${team.color == 'White' ? 'black' : 'white'}` }}>
                      <div style={{ height: 150 + 'px', width: 100 + 'px', margin: 10 + 'px', border: 2 + `px solid ${team.color == 'White' ? 'black' : 'white'}`, borderRadius: 5 + 'px' }}><h5>Deck</h5> <h3>{team.rouleurDeck[0].movement}</h3></div>
